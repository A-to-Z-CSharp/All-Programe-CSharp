...
namespace literal_characters
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*خاصة إدا كانت هناك علامة عشرية.float سواء كابتل أو سمول بدون مسافة بعد قيمة المتغير من نوع f يجب وضع حرف 
            /*خاصة إدا كانت هناك علامة عشرية.decimal سواء كابتل أو سمول بدون مسافة بعد قيمة المتغير من نوع m يجب وضع حرف 
            */
